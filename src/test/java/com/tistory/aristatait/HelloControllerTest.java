...
public class HelloControllerTest {
    ...
    public void test1() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/hello")) // MockMvc 를 통해 /hello 주소로 HTTP GET 요청을 한다.
                .andExpect(MockMvcResultMatchers.status().isOk()) // 위 행의 결과를 검증한다. Header 의 Status 가 200인지 아닌지 검증
